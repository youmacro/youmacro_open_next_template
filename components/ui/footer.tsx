            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                ...
                <Link href="/" className="inline-block" aria-label="Cruip">
                  <img src="../images/youmacro_with_text_white.svg" width={200} height={100} />
                  {/*
              ...
              <div className="text-gray-400">No usage limits. No ads. No subscriptions. Pure 100% free. Just pure video downloading power and simplicity.</div>
